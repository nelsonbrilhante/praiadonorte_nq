...
use App\Http\Controllers\CarsurfReservationController;
...
Route::group([
    ...
    Route::prefix('carsurf')->name('carsurf.')->group(function () {
        ...
        Route::get('/reservas', [CarsurfReservationController::class, 'show'])->name('reservas');
        Route::post('/reservas', [CarsurfReservationController::class, 'store'])->name('reservas.submit');
    });
