    ...
    <section class="py-12">
        <div class="container mx-auto px-4">
            <div class="mx-auto max-w-3xl text-center">
                ...
                <div class="mt-6 inline-flex items-center gap-2 rounded-lg bg-performance/10 px-4 py-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-performance" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
                        <polyline points="22,6 12,13 2,6"/>
                    </svg>
                    <a href="mailto:tiago.barbosa@cm-nazare.pt" class="font-medium text-performance hover:underline">tiago.barbosa@cm-nazare.pt</a>
                </div>
            </div>
        </div>
    </section>
