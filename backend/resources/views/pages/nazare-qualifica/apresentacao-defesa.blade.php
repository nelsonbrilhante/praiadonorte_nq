<x-layouts.app>
    {{-- Hero --}}
    <x-praia-norte.page-hero title="{{ __('messages.nq.contraordenacoes.apresentacaoDefesa.title') }}" subtitle="{{ __('messages.nq.contraordenacoes.apresentacaoDefesa.subtitle') }}" entity="nazare-qualifica">
        <div class="flex flex-wrap gap-4">
            ...
            <x-ui.button href="{{ route('nq.identificacao-condutor') }}" variant="outline" class="border-white bg-transparent text-white hover:bg-white/10">
                {{ __('messages.nq.contraordenacoes.identificacaoCondutor.title') }}
            </x-ui.button>
        </div>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4">
            <div class="mx-auto max-w-3xl text-center">
                <h2 class="mb-6 text-3xl font-bold">{{ __('messages.nq.contraordenacoes.apresentacaoDefesa.title') }}</h2>
                <p class="text-lg text-muted-foreground">
                    {{ __('messages.nq.contraordenacoes.apresentacaoDefesa.intro') }}
                </p>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            <div class="mx-auto max-w-4xl" x-data="{ iframeLoaded: false }">
                <div class="relative w-full overflow-hidden rounded-lg border border-white/10 bg-white shadow-lg">
                    ...
                    <iframe
                        src="https://aid.urbanmotion.pt/defesa/?entity=NAZARE%20QUALIFICA&branding=false"
                        class="h-[800px] w-full border-0"
                        title="{{ __('messages.nq.contraordenacoes.apresentacaoDefesa.title') }}"
                        loading="lazy"
