            ...
            <div class="mx-auto max-w-sm">
                <x-ui.card class="group transition-colors hover:border-institutional">
                    <x-ui.card-content class="pt-6">
                        ...
                        <a href="{{ asset('documents/nq/regulamento-parque.pdf') }}" target="_blank" class="inline-flex items-center gap-2 text-sm font-medium text-institutional hover:underline">
