                ...
                Grid::make(1)
                    ...
                    ->schema([
                        ...
                        Section::make('Título')
                                ...
                                // ========== HOMEPAGE HERO SECTION (visivel apenas para slug=homepage E entity=praia-norte) ==========
                                ...
                                Section::make('Hero da Homepage')
                                    ...
                                    ->schema([
                                        TextInput::make('content.pt.hero.youtube_url')
                                            ...
                                            ->helperText('URL do video YouTube para fundo do Hero')
                                            ->columnSpanFull(),
                                        Grid::make(2)->schema([
                                ...
                                // ========== LANDING PAGE SECTIONS (visiveis apenas para slug=landing) ==========
                                    ...
                                    ->schema([
                                        Grid::make(2)->schema([
                                            FileUpload::make('video_url')
                                                ...
                                                ->helperText('Upload de ficheiro MP4 (max 100MB)'),
                                            TextInput::make('content.pt.hero.youtube_url')
                                                ->label('YouTube URL')
                                                ->url()
                                ...
                                Section::make('Instalações')
                                    ->description('Lista de instalacoes do centro')
                                        ...
                                        Repeater::make('content.pt.conselho')
                                            ...
                                            ->schema([
                                                Grid::make(2)->schema([
                                                    ...
                                                    TextInput::make('role')
                                                        ->label('Cargo')
                                                        ->placeholder('Presidente, 1o Vogal, etc.'),
                                                ]),
                                            ])
                                            ->defaultItems(0)
                                            ->reorderable()
                                ...
                                Section::make('Detalhes do Servico')
                                    ...
                                    ->schema([
                                        ...
                                        // Documents (Estacionamento only)
                                        Section::make('Documentos do Servico')
                                            ->description('PDFs e documentos associados a este servico')
                                            ->icon('heroicon-o-document-arrow-up')
                                            ->schema([
                                                FileUpload::make('content.documents.regulamento')
                                                    ->label('Regulamento (PDF)')
                                                    ->helperText('PDF do regulamento do parque de estacionamento. Substituir elimina o ficheiro anterior.')
                                                    ->acceptedFileTypes(['application/pdf'])
                                                    ->disk('public')
                                                    ->directory('documents/nq')
                                                    ->visibility('public')
                                                    ->maxSize(20480)
                                                    ->openable()
                                                    ->downloadable()
                                                    ->afterStateHydrated(fn ($state, $set, $record) =>
                                                        $set('content.documents.regulamento', $record?->content['documents']['regulamento'] ?? $state)),
                                            ])
                                            ->visible(fn ($get) => $get('slug') === 'estacionamento')
                                            ->collapsible(),
                                    ])
